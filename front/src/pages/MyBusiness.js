    ...
    return (
        <div className='p-4 bg-gray-100 min-h-screen'>
            ...
            <div className="mb-4 flex flex-col md:flex-row justify-between items-center gap-4">
                ...
                />
                <button className="bg-gray-600 text-white px-4 py-2 rounded-md flex items-center" onClick={() => setIsModalOpen(true)} >
                ...
                <div className="fixed inset-0 bg-gray-900 bg-opacity-50 flex justify-center items-center p-4">
                    <div className="bg-white p-6 rounded-lg shadow-lg w-full max-w-lg sm:max-w-md md:max-w-lg lg:max-w-xl relative">
                        ...
                        <form onSubmit={handleSubmit} className="space-y-4">
                            ...
                            <button type="submit" className="w-full bg-gray-600 text-white p-2 rounded-md">Save</button>
                        </form>
                    </div>
                </div>
            )}
